...
namespace iTunesAssistantLib
{
    public static class GratefulDeadTrackFixer
    {
        ...
        private static string GetCanonicalName(string trackName)
        {
            ...
            else if (trackNameKey.Contains("beerbarrelpolka")) { trackName = "Beer Barrel Polka"; }
            ...
            else if (trackNameKey.Contains("brokenstring")) { trackName = "Broken String"; }
            ...
            else if (trackNameKey.Contains("chinadoll")) { trackName = "China Doll"; }
            ...
            else if (trackNameKey.Contains("coldjordon")) { trackName = "Cold Jordan"; }
            ...
            else if (trackNameKey.Contains("crowd")) { trackName = "Crowd"; }
            else if (trackNameKey.Contains("creampuffwar")) { trackName = "Cream Puff War"; }
            else if (trackNameKey.Contains("crypitical")) { trackName = "Cryptical Envelopment"; }
            ...
            else if (trackNameKey.Contains("deepelumblues")) { trackName = "Deep Elem Blues"; }
            ...
            else if (trackNameKey.Contains("gangsteroflove")) { trackName = "Gangster Of Love"; }
            ...
            else if (trackNameKey.Contains("hiheelsneakers")) { trackName = "Hi Heeled Sneakers"; }
            ...
            else if (trackNameKey.Contains("jam")) { trackName = "Jam"; }
            ...
            else if (trackNameKey.Contains("keeprollingby")) { trackName = "Keep Rolling By"; }
            ...
            else if (trackNameKey.Contains("lindy")) { trackName = "Lindy"; }
            ...
            else if (trackNameKey.Contains("milkintheturkey")) { trackName = "King Solomon's Marbles"; }
            else if (trackNameKey.Contains("strongerthandirt")) { trackName = "King Solomon's Marbles"; }
            else if (trackNameKey.Contains("kingsolomonsmarbles")) { trackName = "King Solomon's Marbles"; }
            ...
            else if (trackNameKey.Contains("minglwood")) { trackName = "New Minglewood Blues"; }
            ...
            else if (trackNameKey.Contains("rosaliemcfall")) { trackName = "Rosa Lee McFall"; }
            ...
            else if (trackNameKey.Contains("seasons")) { trackName = "Seasons"; }
            else if (trackNameKey.Contains("philandned")) { trackName = "Seastones"; }
            else if (trackNameKey.Contains("seastones")) { trackName = "Seastones"; }
            ...
            else if (trackNameKey.Contains("smokestack")) { trackName = "Smokestack Lightning"; }
            ...
            else if (trackNameKey.Contains("space")) { trackName = "Space"; }
            ...
            else if (trackNameKey.Contains("banter")) { trackName = "Stage Banter"; }
            ...
            else if (trackNameKey.Contains("starsandstripes")) { trackName = "Stars And Stripes Forever"; }
            ...
            else if (trackNameKey.Contains("takeastepback")) { trackName = "Take A Step Back"; }
            ...
            else if (trackNameKey.Contains("monitor")) { trackName = "Technical Difficulties"; }
            else if (trackNameKey.Contains("techproblems")) { trackName = "Technical Difficulties"; }
            else if (trackNameKey.Contains("technical")) { trackName = "Technical Difficulties"; }
            ...
            else if (trackNameKey.Contains("williamtell")) { trackName = "The Eleven"; }
            ...
            else if (trackNameKey.Contains("fortheotherone")) { trackName = "That's It For The Other One"; }
            ...
            else if (trackNameKey.Contains("whatsbecomeofthebaby")) { trackName = "What's Become Of The Baby?"; }
            ...
            else if (trackNameKey.Contains("whoslovin")) { trackName = "Who's Loving You Tonight?"; }
            ...
            else if (trackNameKey.Contains("yellowdogstory")) { trackName = "Yellow Dog Story"; }
